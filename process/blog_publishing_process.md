...
12. Change the status of the blog post to `ready for publication` in the [post forecast table](https://github.com/meilisearch/devrel/blob/main/communication/post_forecast.md)
