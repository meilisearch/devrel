...
| 4 | Number of integration users | from telemetry data | [chart SDK](https://analytics.amplitude.com/meili/chart/fv0il5i) - [chart plugins](https://analytics.amplitude.com/meili/chart/4sxd8gs) _(private links)_  |
